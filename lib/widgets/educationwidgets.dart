...
class OpenEducPagedWidget extends StatelessWidget {
  OpenEducPagedWidget ({@required this.text, @required this.prop, @required this.n, @required this.onPressed});
...
class OpenEducURLWidget extends StatelessWidget {
  OpenEducURLWidget  ({@required this.text, @required this.prop, @required this.n, @required this.url});
  final  String text; //text du bouton
  final double prop; //nombre de boutons pour connaître la taille en fonction de l'écran du device
  final double n; //position dans le Stack
  final String url;
